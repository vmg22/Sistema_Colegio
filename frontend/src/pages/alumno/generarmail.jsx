...
//   // ✅ CORRECCIÓN: Usar anio_curso, division, anio_lectivo en la URL
//   const cargarAlumnosPorCurso = useCallback(
//     async (cursoId, anioLectivoActual) => {
//       const cursoSeleccionado = cursosDisponibles.find(
//         (c) => c.id_curso === cursoId
...
//       setIsLoadingData(true);
//       try {
//         // ✅ CORRECCIÓN: URL correcta con los 3 parámetros
...
//         const errorMsg =
//           error.response?.data?.message ||
//           `No se encontraron alumnos para el curso ${anio_curso}° ${division}.`;
//         setResponseMessage({ variant: "info", text: errorMsg });
//       } finally {
//         setIsLoadingData(false);
//       }
...
//   // ✅ CORRECCIÓN: Construir el body correctamente según el backend
//   const construirRequestBody = () => {
//     const requestBody = { id_usuario: ID_USUARIO };
...
//       if (tipoEnvio === "notificacion" || selectedIds.length > 1) {
//         // Para notificación o múltiples cursos: enviar array de cursos
//         requestBody.cursos = cursosDisponibles
//           .filter((c) => selectedIds.includes(c.id_curso))
//           .map((c) => ({
//             anio_curso: c.anio_curso,
...
//           }));
//       } else if (selectedIds.length === 1) {
//         // Para un solo curso (alerta o reunión): enviar campos individuales
//         const cursoSeleccionado = cursosDisponibles.find(
//           (c) => c.id_curso === selectedIds[0]
//         );
//         requestBody.anio_curso = cursoSeleccionado.anio_curso;
...
//     } else if (tipoEnvio === "alerta") {
//       requestBody.faltasMaximas = 20;
//       // ✅ CORRECCIÓN: Para alerta NO enviar notificacionData, solo faltasMaximas
//       // El mensaje de alerta se genera automáticamente en el backend
//     } else if (tipoEnvio === "notificacion") {
//       requestBody.notificacionData = {
//         asunto: mailData.asunto,
//         mensaje: mailData.mensaje,
...
//   // ✅ CORRECCIÓN: Obtener el endpoint correcto
//   const obtenerEndpoint = () => {
//     if (tipoDestino === "alumnos") {
//       return ENDPOINTS[tipoEnvio].alumno;
//     }
...
//       setResponseMessage({
//         variant: "success",
//         text: data.message || "Envío exitoso.",
//       });
...
//                 ) : (
//                   alumnosFiltrados.map((alumno) => (
//                     <div key={alumno.dni_alumno} style={styles.checkboxItem}>
//                       <Form.Check
//                         type="checkbox"
//                         label={`${alumno.apellido_alumno} ${alumno.nombre_alumno} (${alumno.dni_alumno})`}
//                         checked={selectedAlumnosDNI[alumno.dni_alumno] || false}
//                         onChange={() => handleToggleAlumno(alumno.dni_alumno)}
//                         disabled={isSendDisabled}
//                       />
//                     </div>
//                   ))
