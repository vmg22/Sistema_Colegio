...
//   // Obtener rol del usuario (ajusta según tu sistema de autenticación)
...
//     // Ajusta esto según tu implementación (localStorage, context, API, etc.)
//     const role = localStorage.getItem("userRole") || "usuario"; // Por defecto "usuario"
//     setUserRole(role);
...
//   // 🔥 NUEVO: Función para navegar al CRUD
//   const handleNavigateToCrud = () => {
//     navigate("/crud"); // Ajusta la ruta según tu aplicación
//   };
...
//         {/* 🔥 NUEVO: Card de Gestión de Datos solo para admin */}
//         {userRole === "admin" && (
//           <button
