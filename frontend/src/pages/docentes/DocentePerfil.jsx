...
const DocentePerfil = () => {
    ...
    const fetchData = async () => {
        try {
            ...
            const [docenteData, asignacionesData, materiasData, cursosData] = await Promise.all([
    ...
    const columnsAsignaciones = [
        ...
        { 
          ...
          cell: (item) => `${item.curso_nombre} (${item.curso_anio}° ${item.curso_division})`
        },
    ...
    if (isLoading) return <div className="gestion-page-container"><p>Cargando perfil...</p></div>;
    // No mostramos el error principal si solo es un error de carga de asignaciones
    if (error && !docente) return <div className="gestion-page-container"><p className="error-message">{error}</p></div>;
    if (!docente) return <div className="gestion-page-container"><p>Docente no encontrado.</p></div>;
...
<div className="perfil-banner">
                ...
                <div className="docente-info">
                    ...
                    <p className="docente-username">@{docente.username || 'sin-usuario'}</p>
                </div>
            </div>
            ...
            <div className="perfil-grid">
                ...
                <div className="perfil-info-box">
                    ...
                    <dl>
                        ...
                        <dd>{docente.nombre} {docente.apellido}</dd>
                        ...
                        <dt>Estado</dt>
                        <dd>
                            <span className={`status-badge ${docente.estado_docente?.toLowerCase() || 'inactivo'}`}>
                        ...
                        {asignaciones.length > 0 ? (
                            asignaciones.map(asig => (
                                <li key={asig.id_asignacion}>
                                    {asig.materia_nombre} - {asig.curso_anio}° {asig.curso_division}
                                </li>
                            ))
                        ) : (
            ...
            <div className="list-container">
                <div className="list-header">
                    ...
                    <button onClick={() => handleOpenAsignacionModal()} className="add-button">
