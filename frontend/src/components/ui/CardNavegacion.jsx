...
// No es necesario importar LinkCrud.css aquí si los estilos están en línea
...
const styles = {
    ...
    boxShadow: "0 8px 16px rgba(0,0,0,0.1)", // Sombra más suave en hover
...
const CardNavegacion = ({ titulo, icono, to }) => {

// Usamos el useState importado
